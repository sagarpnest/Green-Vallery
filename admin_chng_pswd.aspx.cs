...
//public partial class admin_chng_pswd : System.Web.UI.Page
//{
...
public partial class admin_chng_pswd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter sda = new SqlDataAdapter("select * from Admin_table where Email_id='" + TextBox1.Text + "' and Password='" + TextBox2.Text + "'", con);
        ...
        if (dt.Rows.Count.ToString() == "1")
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update Admin_table set Password='" + TextBox4.Text + "' where Email_id='" + TextBox1.Text + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
