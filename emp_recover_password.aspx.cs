...
//public partial class emp_recover_password : System.Web.UI.Page
//{
...
public partial class emp_recover_password : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select COUNT(*)FROM Employee_table WHERE Email_id='" + TextBox1.Text + "' and Contact_number='" + TextBox2.Text + "'");
        cmd.Connection = con;
        ...
        if (OBJ > 0)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("select * FROM Employee_table WHERE Email_id='" + TextBox1.Text + "' and Contact_number='" + TextBox2.Text + "'");
            cmd1.Connection = con;
